...
| スラッシュコマンドを探す                    | チャット画面の入力欄で `/` を打つ（↑↓で選び、Tab か Enter で確定）                  |
...
| 領域                                                    | 状態                                                   |
| ------------------------------------------------------- | ------------------------------------------------------ |
| 純粋ロジック層（引数組み立て・パーサ・一覧・状態遷移）  | 完了、テスト347件                                      |
| Codex画面（対話・承認・分岐・タブ名・待ち行列・ループ） | 実機確認済み（2026-08-10）                             |
