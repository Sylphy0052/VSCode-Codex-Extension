    ...
    if (message.type === 'refreshCi' && typeof message['branch'] === 'string') {
      ...
      this.post(
        result.ok
          ...
          : { type: 'ciResult', ok: false, message: result.message, requestId },
      );
      this.postSnapshot();
      return;
    }
