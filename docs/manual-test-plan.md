...
| W群 | ワークフロー（並列オーケストレーション） | 7 | W-A〜W-F, W-H |
...
W群のうち **W-F と W-H は WF-E が確定させた**（2026-08-23）。ただし**実体は統合ブランチ
...
- **WF-E**: 残りは W-G と W-I〜W-Q（W1〜W12に1件ずつ。**W-F と W-H は上のとおり追加済み**。
...
| 7 | W群 | 7（WF-E完了後は17） | W-Dは実ホスト（GitHub/GitLab）が要る。WF-E完了後は W-G と W-I〜W-Q が加わり、W-N / W-O は実VSCodeの再起動とWSLの停止を伴う |
