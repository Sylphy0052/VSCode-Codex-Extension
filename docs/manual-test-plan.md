...
現時点で実機確認が要るのは **194件**。内訳は次のとおり。

| 群  | 対象                                     | 件数 | 範囲                                            |
| --- | ---------------------------------------- | ---- | ----------------------------------------------- |
| C群 | Codex画面（app-server）                  | 56   | C-01〜C-02, C-11, C-13b〜C-17, C-20, C-22〜C-58 |
...
| 3   | C群の表示系（C-49〜C-52h, C-56〜C-58）                        | 14   | 進捗タブと応答の表示・使用量の見た目。C-53〜C-55はワークフロー画面の表示なので回9へ回す                                       |
