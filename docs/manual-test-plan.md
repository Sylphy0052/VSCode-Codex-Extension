...
| W群 | ワークフロー（並列オーケストレーション） | 11 | W-A〜W-H, W-L, W-N, W-P |
...
W群のうち **W-F・W-G・W-H・W-L・W-N・W-P は WF-E が確定させた**（2026-08-23）。ただし**実体は統合ブランチ
...
- **WF-E**: 残りは W-I〜W-K・W-M・W-O・W-Q（W1〜W12に1件ずつ。**W-F・W-G・W-H・W-L・W-N・W-P は上のとおり追加済み**。
...
| 7 | W群 | 11（WF-E完了後は17） | W-Dは実ホスト（GitHub/GitLab）が要る。WF-E完了後は W-I〜W-K・W-M・W-O・W-Q が加わり、W-O は実VSCodeの再起動とWSLの停止を伴う。W-P もブランチ保護を設定した実ホストが要る |
