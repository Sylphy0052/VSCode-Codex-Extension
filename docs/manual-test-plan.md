...
| W群 | ワークフロー（並列オーケストレーション） | 15 | W-A〜W-J, W-L, W-M, W-N, W-O, W-P |
...
W群のうち **W-F・W-G・W-H・W-I・W-J・W-L・W-M・W-N・W-O・W-P は WF-E が確定させた**（2026-08-23）。ただし**実体は統合ブランチ
...
- **WF-E**: 残りは W-K・W-Q（W1〜W12に1件ずつ。**W-F〜W-J・W-L〜W-P は上のとおり追加済み**。
...
| 7 | W群 | 15（WF-E完了後は17） | W-Dは実ホスト（GitHub/GitLab）が要る。WF-E完了後は W-K・W-Q が加わる。**W-O は実VSCodeの再起動とWSLの停止を伴う**。W-P もブランチ保護を設定した実ホストが要る |
