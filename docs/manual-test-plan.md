...
| W群 | ワークフロー（並列オーケストレーション） | 8 | W-A〜W-F, W-H, W-P |
...
W群のうち **W-F・W-H・W-P は WF-E が確定させた**（2026-08-23）。ただし**実体は統合ブランチ
...
- **WF-E**: 残りは W-G・W-I〜W-O・W-Q（W1〜W12に1件ずつ。**W-F・W-H・W-P は上のとおり追加済み**。
  ...
  **2026-08-22にW6〜W12を追加したため、当初の W-F〜W-J から W-Q までへ広がっている**（Issue #497）。
  増えた7件のうち W-N（W9、タスク間メッセージングのオーケストレーター中継化）と
  W-O（W10、中断からの自動再開）は、**実ホストではなく実VSCodeの再起動やWSLの停止を伴う**ため、
...
| 7 | W群 | 8（WF-E完了後は17） | W-Dは実ホスト（GitHub/GitLab）が要る。WF-E完了後は W-G・W-I〜W-O・W-Q が加わり、W-N / W-O は実VSCodeの再起動とWSLの停止を伴う。W-P もブランチ保護を設定した実ホストが要る |
