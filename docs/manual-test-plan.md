...
| W群 | ワークフロー（並列オーケストレーション） | 14 | W-A〜W-I, W-L, W-M, W-N, W-O, W-P |
...
W群のうち **W-F・W-G・W-H・W-I・W-L・W-M・W-N・W-O・W-P は WF-E が確定させた**（2026-08-23）。ただし**実体は統合ブランチ
...
- **WF-E**: 残りは W-J・W-K・W-Q（W1〜W12に1件ずつ。**W-F〜W-I・W-L〜W-P は上のとおり追加済み**。
  ...
  **2026-08-22にW6〜W12を追加したため、当初の W-F〜W-J から W-Q までへ広がっている**（Issue #497）。
  ...
  下の「実施の順序」でW群を通すときに一緒に確かめる（W-Oは着地済みで、上のとおり内容が確定している）。
...
| 7 | W群 | 14（WF-E完了後は17） | W-Dは実ホスト（GitHub/GitLab）が要る。WF-E完了後は W-J・W-K・W-Q が加わる。**W-O は実VSCodeの再起動とWSLの停止を伴う**。W-P もブランチ保護を設定した実ホストが要る |
