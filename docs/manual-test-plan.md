...
現時点で実機確認が要るのは **193件**。内訳は次のとおり。

| 群  | 対象                                     | 件数 | 範囲                                            |
| --- | ---------------------------------------- | ---- | ----------------------------------------------- |
| C群 | Codex画面（app-server）                  | 55   | C-01〜C-02, C-11, C-13b〜C-17, C-20, C-22〜C-58 |
...
| 3   | C群の表示系（C-49〜C-52g, C-56〜C-58）                        | 13   | 進捗タブと応答の表示・使用量の見た目。C-53〜C-55はワークフロー画面の表示なので回9へ回す                                       |
...
| 8   | U-34〜U-47                                                    | 14   | 会話の見え方・セカンドオピニオン・ゴールの下書き。回7と同じ画面で続けて通せる                                                 |
...
回6でH群をC群・L群の後に置くのは、履歴とタブ復元の確認に**実際の会話が残っている状態**が
