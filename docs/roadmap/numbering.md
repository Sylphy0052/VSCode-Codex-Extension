...
| WF-E ワークフローの自律性 | 2 | 12 | [#341](https://github.com/Sylphy0052/VSCode-Codex-Extension/issues/341) | `wf/wf-e/integration` | 完了（PR [#631](https://github.com/Sylphy0052/VSCode-Codex-Extension/pull/631)、mainへマージ済み。統合ブランチは削除済み） |
...
| WF-G 横断の仕上げ | 3 | 18 | 未採番 | `wf/wf-g/integration` | 完了（18項目がすべてCLOSED。最終の全体レビューはPR [#676](https://github.com/Sylphy0052/VSCode-Codex-Extension/pull/676)でmainへマージ済み） |
| WF-H オーケストレーション実行の精度 | 4 | 7 | 未採番 | `wf/wf-h/integration` | 着手可能。**節番号とケース記号は事前予約しない**（波をまたぐ予約は Issue [#487](https://github.com/Sylphy0052/VSCode-Codex-Extension/issues/487) と同じ形で腐るため）。詳細は [orchestration-accuracy.md](orchestration-accuracy.md) |
